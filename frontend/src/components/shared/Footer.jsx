  ...
  return (
    <div className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            We are commited to delievering the best service and information. Our
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">Phone: +91 234 567 8901</p>
        </div>
      </div>
      ...
      <div className="mt-8 border-t border-gray-700 pt-6 text-center text-gray-500 text-sm">
        ...
        <p className="mt-4">&copy; {new Date().getFullYear()} News Nova. All rights reserved.</p>
      </div>
    </div>
  );
}
